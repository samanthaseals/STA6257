...
-   When both spines are good, for each 1 cm width increase, we expect the satellite count to be multiplied by $e^{0.206} = 1.2288$, an increase of 22.88%.
...
-   where
    -   $y$ is the number of occurrences ($y$ = 0, 1, 2 , ... ),
